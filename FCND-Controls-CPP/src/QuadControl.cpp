...
V3F QuadControl::BodyRateControl(V3F pqrCmd, V3F pqr)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  // 3D DRONE-FULL-NOTEBOOK (Lesson 4) - Body Rate Controller
...
V3F QuadControl::RollPitchControl(V3F accelCmd, Quaternion<float> attitude, float collThrustCmd)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
//    3D DRONE-FULL-NOTEBOOK (Lesson 4) - ROLL PITCH CONTROLLER
  // def roll_pitch_controller(self, b_x_c, b_y_c,rot_mat):
 //         b_x = rot_mat[0, 2]
 //         b_x_err = b_x_c - b_x
...
float QuadControl::AltitudeControl(float posZCmd, float velZCmd, float posZ, float velZ, Quaternion<float> attitude, float accelZCmd, float dt)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
    ...
    //    3D DRONE-FULL-NOTEBOOK (Lesson 4) - ALT Controller
